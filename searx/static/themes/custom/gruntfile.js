...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    image: {
      svg4web: {
        ...
        files: {
          '<%= _templates %>/custom/searxng-wordmark.min.svg': '<%= _brand %>/searxng-wordmark.svg',
    ...
    svg2jinja: {
      all: {
        ...
        dest: '../../../templates/custom/icons.html',
      },
    },
  });
  ...
  grunt.registerMultiTask('svg2jinja', 'Create Jinja2 macro', function () {
    ...
    const template = `{# this file was generated by searx/static/themes/custom/gruntfile.js #}
{%- set icons = {
